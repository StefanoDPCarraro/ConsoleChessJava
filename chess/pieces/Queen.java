...
public class Queen extends ChessPiece {
    ...
    public boolean[][] possibleMoves() {
        ...
        //MARKS AS TRUE THE POSSIBLE POSITIONS ABOVE THE QUEEN
        ...
        //MARKS AS TRUE THE POSSIBLE POSITIONS TO THE LEFT OF THE QUEEN
        ...
        //MARKS AS TRUE THE POSSIBLE POSITIONS BELOW THE QUEEN
        p.setValues(getPosition().getRow() + 1, getPosition().getColumn());
        while (getBoard().positionExists(p) && !getBoard().thereIsAPiece(p)){
            mat[p.getRow()][p.getColumn()] = true;
            p.setRow(p.getRow()+1);
        ...
        //MARKS AS TRUE THE POSSIBLE POSITIONS TO THE RIGHT OF THE QUEEN
        p.setValues(getPosition().getRow(), getPosition().getColumn() + 1);
        while (getBoard().positionExists(p) && !getBoard().thereIsAPiece(p)){
            mat[p.getRow()][p.getColumn()] = true;
            p.setColumn(p.getColumn() + 1);
